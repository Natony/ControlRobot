atan2 MATLAB .NET Assembly (.NET Component)
...
atan2_overview.html - HTML overview documentation file for the generated component. It 
                      contains the requirements for accessing the component and for 
                      generating arguments using the MWArray class hierarchy.

atan2.xml - This file contains the code comments for the atan2 component classes and 
                      ...
                      online documentation for the atan2 component.
